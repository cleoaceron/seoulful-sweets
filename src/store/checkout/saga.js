...
function* fnGetQoutations({ payload }) {
  try {
    const response = yield call(checkoutServices.api.fnGetQoutations, payload);
...
export default function* watcher() {
  ...
  yield takeLatest(GET_QUOTATIONS, fnGetQoutations);
}

...
const MerchLogin = ({ authentication, ...props }) => {
  ...
  document.title = "Seoulful Sweets | Login";
                  ...
                  <div className="d-flex flex-column h-100">
                    <div className="mb-4 mb-md-5 text-center">
                      <Link to="/home" className="d-block auth-logo">
                        <img src={seoulfulLogo} alt="" height="120" />{" "}
                        {/* <span className="logo-txt">Seoulful Sweets ❤️</span> */}
                      </Link>
                    </div>
                    ...
                    <div className="mt-4 mt-md-5 text-center">
                      <p className="mb-0">
                        © {new Date().getFullYear()} Seoulful Sweets Store.
                      </p>
                    </div>
                  </div>
                </div>
